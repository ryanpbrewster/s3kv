...
scan:
  source .aws/credentials && RUST_LOG=etl=debug,s3kv=debug cargo run --release --bin scan -- --region us-west-2 --bucket rpbtest --prefix "2023-05-05T19:01:42+00:00" --block-size 10000000 --start VACST22S
